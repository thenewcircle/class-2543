...
public class LogActivity extends Activity {
	...
	public void onClickLog(View v) {
		...
		case R.id.radio_debug:
			priorityInt = LogManager.DEBUG;
			break;
		case R.id.radio_warn:
			priorityInt = LogManager.WARN;
			break;
		case R.id.radio_error:
			priorityInt = LogManager.ERROR;
			break;
		}

		LogMessage message = new LogMessage(priorityInt, tagString,
				messageString);
		logManager.loggit(message);
	}
}